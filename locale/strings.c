...
"MsgPaypalEnterName" = "Enter Name";  //Do not translate
"MsgPaypalSelectCustomer" = "Select Customer";  //Do not translate
"MsgPaypalCustomers" = "Checked In Customers";  //Do not translate
"MsgPaypalInvoiceCreateFailed" = "Payment Failed\n[%d %@]";  //Do not translate

"MsgPaypalLocationsFetchFailed" = "PayPal server is not available.";  //Do not translate

"MsgPaypalPaymentConfirm" = "Charge %@ to %@ using PayPal?%@";  //Do not translate
"MsgPaypalPaymentApprovedTitle" = "Transaction Approved";  //Do not translate
"MsgPaypalPaymentApprovedText" = "%@ charged to %@ using PayPal.";  //Do not translate
"MsgPaypalPaymentDeniedTitle" = "Transaction Denied";  //Do not translate
"MsgPaypalPaymentDeniedText" = "%@ was not charged to %@ using PayPal.";  //Do not translate
"MsgPaypalPaymentMinAmount" = "Minimum amount for credit card payment is %@.";  //Do not translate
...
"MsgPaypalUnauthRequest" = "Unauthorized Request";  //Do not translate
"MsgPaypalTenderByOtherMeans" = "TENDER BY OTHER MEANS";  //Do not translate
"MsgPaypalCorrection" = "Correction";  //Do not translate
"MsgPaypalCheckSettings" = "Please check your settings...";  //Do not translate
"MsgPaypalCorrelationId" = "Correlation ID";  //Do not translate
"MsgPaypalUnknownError" = "Unknown Error";  //Do not translate
...
"MsgGasStationPumpHasReserverByThisTerminal" = "%@ has reserved by this terminal. Please cancel reservation."; //Do not translate
"MsgGasStationPumpHasReserverTransactionByThisTerminal" = "%@ has current transaction with id %d reserved by this terminal. Please cancel reservation."; //Do not translate
"MsgGasStationPumpHasStackTransactionReservedBytThisTerminal" = "%@ has stack transaction with id %d reserved by this terminal. Please cancel reservation."; //Do not translate
...
"BtnDiscountNoDiscount" = "No Discount";
"BtnApplyDiscounts" = "Apply Discounts";

/*TAXES*/
"MsgChoosePrevailingTaxes" = "Choose Prevailing Taxes"; // b1525;
...
"MsgOrderSpeakShowDiscountScreen" = "Select a Product Discount";  //Do not translate
"MsgOrderSpeakSelectedDiscount" = "Selected discount is %@.";  //Do not translate
"MsgOrderSpeakSelectedDiscountIsTheFirst" = "Selected discount is the first one.";  //Do not translate
"MsgOrderSpeakSelectedDiscountIsTheLast" = "Selected discount is the last one.";  //Do not translate
"MsgOrderSpeakDiscountApplied" = "Discount %@ has been applied to the order.";  //Do not translate

"MsgOrderSpeakShowHeldOrdersScreen" = "Select a Held Order.";  //Do not translate
"MsgOrderSpeakNoHeldOrder" = "There are no held orders.";  //Do not translate
"MsgOrderSpeakSelectedOrder" = "Selected order is %@.";  //Do not translate
"MsgOrderSpeakSelectedOrderIsTheFirst" = "Selected order is the first one.";  //Do not translate
"MsgOrderSpeakSelectedOrderIsTheLast" = "Selected order is the last one.";  //Do not translate


"MsgOrderSpeakShowModifierScreen" = "Select a Modifier.";  //Do not translate
"MsgOrderSpeakSelectedModifier" = "Selected modifier is %@.";  //Do not translate
"MsgOrderSpeakSelectedModifierIsTheFirst" = "Selected modifier is the first one.";  //Do not translate
"MsgOrderSpeakSelectedModifierIsTheLast" = "Selected modifier is the last one.";  //Do not translate
"MsgOrderSpeakModifierAdded" = "Modifier %@ added to the order.";  //Do not translate
"MsgOrderSpeakModifierRemoved" = "Modifier %@ removed from the order.";  //Do not translate

"MsgOrderSpeakSelectedGroup" = "Selected group is %@.";  //Do not translate
"MsgOrderSpeakSelectedGroupIsTheFirst" = "Selected group is the first one.";  //Do not translate
"MsgOrderSpeakSelectedGroupIsTheLast" = "Selected group is the last one.";  //Do not translate

"MsgOrderSpeakAmountDue" = "Amount due is %@.";  //Do not translate
"MsgOrderSpeakOrderCloseSuccess" = "Order was closed.";  //Do not translate
"MsgOrderSpeakOrderCloseFail" = "Order cannot be closed.";  //Do not translate
"MsgOrderSpeakPaymentDone" = "Payment complete. Amount due is %@. Change is %@.";  //Do not translate
"MsgOrderSpeakOrderLoading" = "Loading Order %@";  //Do not translate
"MsgOrderSpeakOrderLoadingOK" = "Order %@ was loaded.";  //Do not translate
"MsgOrderSpeakOrderLoadingFail" = "Order %@ could not be loaded.";  //Do not translate
"MsgOrderSpeakCashPay" = "Amount tendered %@.";  //Do not translate
"MsgOrderSpeakEntered" = "You entered %@.";  //Do not translate
"MsgOrderSpeakCCPay" = "Swipe credit card. Amount due is %@.";  //Do not translate
"MsgOrderSpeakHasItems" = "Order has following items:";  //Do not translate
"MsgOrderSpeakItem" = "Item %d. %@";  //Do not translate
"MsgOrderSpeakItemRemoved" = "Item %d %@ was removed.";  //Do not translate
"MsgOrderSpeakTotal" = "Order total is %@.";  //Do not translate
"MsgOrderSpeakHoldOrder" = "Order was held.";  //Do not translate
"MsgOrderSpeakShowPayScreen" = "Pay screen was displayed";  //Do not translate
"MsgOrderSpeakShowSearchScreen" = "Product search is on.";  //Do not translate
"MsgOrderSpeakShowSearchScreenOff" = "Product search is off.";  //Do not translate
"MsgOrderSpeakSelectedProduct" = "Selected product is %@.";  //Do not translate
"MsgOrderSpeakProductNotFound" = "No products found.";  //Do not translate
"MsgOrderSpeakSelectedProductIsTheFirst" = "Selected product is the first one.";  //Do not translate
"MsgOrderSpeakSelectedProductIsTheLast" = "Selected product is the last one.";  //Do not translate
"MsgOrderSpeakProductAdded" = "Product %@ added to the order.";  //Do not translate
"MsgOrderProductAdded" = "Product added";
"MsgOrderAddProducts" = "Add products";
"MsgOrderSpeakAccessibilityOff" = "Keyboard support switched off.";  //Do not translate
"MsgOrderSpeakAccessibilityOn" = "Keyboard support switched on.";  //Do not translate
"MsgOrderSpeakLoginSuccess" = "You have logged in to the app.";  //Do not translate
"MsgOrderSpeakLoginFail" = "Invalid PIN.";  //Do not translate
"MsgOrderSpeakCancelOrderCancel" = "Cancellation of the order was aborted.";  //Do not translate
"MsgOrderSpeakCancelOrderSuccess" = "Order was canceled.";  //Do not translate
...
"MsgOrderSpeakSlowdownSuccess" = "Voice speed decreased.";  //Do not translate
"MsgOrderSpeakSlowdownFail" = "Voice cannot be slower.";  //Do not translate
"MsgOrderSpeakSpeedupSuccess" = "Voice speed increased.";  //Do not translate
"MsgOrderSpeakSpeedupFail" = "Voice cannot be faster.";  //Do not translate
...
/*PRINT MONERIS BATCH TOTALS*/

"MsgPrintBatchTotals" = "BATCH TOTALS";  //Do not translate
"MsgPrintBatch" = "Batch";  //Do not translate
"MsgPrintHostTransaction" = "Host Transactions:";  //Do not translate
"MsgPrintCount" = "Count:";  //Do not translate
"MsgPrintPurchaseCorrection" = "Purchase Correction:";  //Do not translate
"MsgPrintPedTransactions" = "Ped Transactions:";  //Do not translate
"MsgPrintPurchase" = "Purchase:";  //Do not translate
"MsgPrintRefund" = "Refund:";  //Do not translate
"MsgPrintOutOfBalance" = "OUT OF BALANCE";  //Do not translate
...
"MsgReceiptBankDropAmountOfDropTotal" = "Amount of Drop Total";
...
"MsgReceiptSingaporeSubtotalWithSFee" = "GST";  //Do not translate
"MsgReceiptSingaporeServiceFee" = "SVC CHG";  //Do not translate
...
"MsgReceiptHST" = "HST";  //Do not translate
"MsgReceiptGSTIncluded" = "GST Included";  //Do not translate
"MsgReceiptSeat" = "Seat";
...
"MsgReceiptProductForecastingStartOfReport" = "Product Forecasting Report";
"MsgReceiptProductForecastingEndOfReport" = "End of Report";
"MsgReceiptProductForecastingPrep" = "Prep";
"MsgReceiptProductForecastingTotalsForDay" = "Totals for the day";
"MsgReceiptProductForecastingNextDay" = "Next day";
"MsgReceiptProductForecastingForecast" = "Fcst";
"MsgReceiptProductForecastingEstimated" = "Est";
"MsgReceiptProductForecastingCumulative" = "Cumulative";
"MsgReceiptProductForecastingPrior" = "Prior";
"MsgReceiptProductForecastingNotificationBody" = "Time to print %@ report";
"MsgReceiptProductForecastingStartOfDay" = "Start of Day";
"MsgReceiptProductForecastingTimeSlot" = "Time slot";
...
"MsgPaymentEBTNotSupported" = "EBT transactions are not supported by your credit processor.";  //Do not translate
...
"MsgPaymentUSAEpayEncryptionError" = "Check your encryption level in the backend settings!";  //Do not translate
"MsgPaymentUSAEpayUrlIncorrect" = "USAePay service url is incorrect.\nPlease contact customer support.";  //Do not translate
"MsgPaymentUSAEpayOfflineProcessingError" = "Did expect to process an offline payment here!";  //Do not translate
...
"MsgPaymentPayWithEBTCard" = "Pay with EBT Card";  //Do not translate
"MsgPaymentPartialRefundIsNotAllowedWithEBT" = "Partial refund is not allowed with EBT.";  //Do not translate
...
"MsgPaymentWaitForTransaction" = "Waiting for Transaction Tyro Payments";  //Do not translate
...
"MsgMonerisPrintTotals" = "Print Totals";  //Do not translate
"MsgMonerisResetTotals" = "Reset POS Totals";  //Do not translate
"MsgMonerisInitializePinPad" = "Initialize PinPad";  //Do not translate
"MsgMonerisNothingToPrint" = "Nothing to print.";  //Do not translate
"MsgMonerisDeviceBusy" = "Moneris device busy.\nTry again later...";  //Do not translate
"MsgMonerisRequestingBatchInfo" = "Requesting batch info ... Please wait";  //Do not translate
"MsgMonerisSAFRecordsReleased" = "SAF records released.";  //Do not translate
"MsgMonerisSAFFloorLimit" = "SAF Floor Limit";  //Do not translate
"MsgMonerisPinPadStillDisconnected" = "PinPad still disconnected.";  //Do not translate
"MsgMonerisSAFTableEmpty" = "SAF table empty";  //Do not translate
"MsgMonerisSAFDisabled" = "SAF is disabled!\nPlease initialize device.";  //Do not translate
"MsgMonerisReleasingRecords" = "Releasing Records";  //Do not translate
"MsgMonerisSAFRelease" = "SAF Release";  //Do not translate
"MsgMonerisDeviceInitializedWithSAF" = "Device successfully initialized!\nPlease set floor limits for each supported card plan.";  //Do not translate
"MsgMonerisDeviceInitialized" = "Device successfully initialized!";  //Do not translate
"MsgMonerisDeviceIsNotInitialized" = "Device is not initialized. Initialize?";  //Do not translate
"MsgMonerisActionFailedRetry" = "Action failed. Retry?";  //Do not translate
"MsgMonerisInternalErrorWithCode" = "Internal Error (%@)";  //Do not translate
"MsgMonerisEMVCardErrorWithCode" = "EMV Card Error (%@)";  //Do not translate
"MsgMonerisInitErrorWithCode" = "Initialization Failed (%@)";  //Do not translate
"MsgMonerisDataErrorWithCode" = "Data Error (%@)";  //Do not translate
"MsgMonerisPinPadErrorWithCode" = "PinPad Error (%@)";  //Do not translate
"MsgMonerisMiscErrorWithCode" = "Miscellaneous Error (%@)";  //Do not translate
"MsgMonerisCancelFailed" = "Cancel action failed. Transaction in progress...";  //Do not translate
"MsgMonerisActionFailed" = "Action failed";
"MsgPaymentDebitRefund" = "Debit Refund";
"MsgPaymentEBTSale" = "EBT Sale";  //Do not translate
...
"MsgPaymentEBTFoodstampAllowedAmount" = "EBT Foodstamp allowed amount is %.2f";  //Do not translate
"MsgPaymentEBTRequestedAmount" = "Requested amount: %@";  //Do not translate
"MsgPaymentEBTFoodstampIsNotAllowed" = "EBT Foodstamp transaction is not allowed for current order.";  //Do not translate
"MsgPaymentEBTPartialPaymentIsNotSupported" = "Partial payment is not supported with EBT.";  //Do not translate
"MsgPaymentEBTValidatingOrder" = "Validating Order";  //Do not translate
...
"MsgFirstDataCreditCardPinPadTitle" = "First Data PinPad";  //Do not translate
"MsgFirstDataCreditCardPinPadBusy" = "PinPad Busy. Try again later";  //Do not translate
"MsgFirstDataCreditCardPinPadNotConnected" = "PinPad not connected";  //Do not translate
"MsgFirstDataCreditCardPinPadNotError" = "Error occured. Please retry";  //Do not translate
"MsgFirstDataCreditCardIndicationInsertCard" = "Insert Chip card";  //Do not translate
"MsgFirstDataCreditCardIndicationInsertCardAgain" = "Chip card error. Insert card again";  //Do not translate
"MsgFirstDataCreditCardIndicationSwipeCard" = "Swipe card";  //Do not translate
"MsgFirstDataCreditCardIndicationPinRequest" = "PIN Request";  //Do not translate
"MsgFirstDataCreditCardIndicationSelectApplication" = "Application select";  //Do not translate
"MsgFirstDataCreditCardIndicationBalanceOnPinpad" = "Balance on PinPad";  //Do not translate
"MsgFirstDataCreditCardIndicationConnectingToServer" = "Connecting to server";  //Do not translate
"MsgFirstDataCreditCardIndicationRemoveCard" = "Remove card";  //Do not translate
"MsgFirstDataCreditCardBreakCardError" = "Card error";  //Do not translate
"MsgFirstDataCreditCardBreakCardNotAllowed" = "Card not allowed";  //Do not translate
"MsgFirstDataCreditCardBreakNoSupportedApplication" = "No supported application";  //Do not translate
"MsgFirstDataCreditCardBreakTransactionBlocked" = "Transaction blocked";  //Do not translate
"MsgFirstDataCreditCardBreakBadReceiptNumber" = "Bad receipt number";  //Do not translate
"MsgFirstDataCreditCardBreakUnknownError" = "Unknown error";  //Do not translate
"MsgFirstDataCreditCardBreakTimeout" = "Timeout";  //Do not translate
"MsgFirstDataCreditCardBreakFallback" = "Fallback";  //Do not translate
"MsgFirstDataCreditCardBreakSettlementRequired" = "Settlement is required";  //Do not translate
"MsgFirstDataCreditCardBreakTransactionAlreadyExists" = "Transaction with such number already exists";  //Do not translate
"MsgFirstDataCreditCardBreakCardEncryptionError" = "Card encryption error";  //Do not translate
"MsgFirstDataCreditCardBreakCardCommonError" = "Common Error";  //Do not translate
"MsgFirstDataCreditCardReceiptTitle" = "CREDIT CARD RECEIPT";  //Do not translate
"MsgFirstDataCreditCardReceiptTerminalId" = "Terminal ID";  //Do not translate
"MsgFirstDataCreditCardReceiptMerchantId" = "Merchant ID";  //Do not translate
"MsgFirstDataCreditCardReceiptBatchId" = "BATCH";  //Do not translate
"MsgFirstDataCreditCardReceiptInvoiceId" = "INVOICE";  //Do not translate
"MsgFirstDataCreditCardReceiptDate" = "DATE";  //Do not translate
"MsgFirstDataCreditCardReceiptTime" = "TIME";  //Do not translate
"MsgFirstDataCreditCardReceiptAmount" = "AMOUNT";  //Do not translate
"MsgFirstDataCreditCardReceiptPurchaseTitle" = "SALE";  //Do not translate
"MsgFirstDataCreditCardReceiptVoidTitle" = "VOID";  //Do not translate
"MsgFirstDataCreditCardReceiptRefundTitle" = "REFUND";  //Do not translate
"MsgFirstDataCreditCardReceiptCustomerSaveReceipt" = "Please save this receipt for your records";  //Do not translate
"MsgFirstDataCreditCardReceiptPinConfirmed" = "Pin correct";  //Do not translate
"MsgFirstDataCreditCardReceiptAuthorization" = "AUTHORIZATION";  //Do not translate
"MsgFirstDataCreditCardReceiptTransactionDeclined" = "Transaction Declined";  //Do not translate
"MsgFirstDataCreditCardSettlementRequired" = "Settlement required. Go to Manager and select Batch Process to perform Settlement";  //Do not translate
"MsgFirstDataCreditCardSettlementCompleted" = "Settlement was completed successfully";  //Do not translate
"MsgFirstDataCreditCardSettlementFailed" = "Settlement completed with errors";  //Do not translate
"MsgFirstDataCreditCardSettlementFailedRetry" = "Settlement failed. Please retry to complete settlement";  //Do not translate
"MsgFirstDataCreditCardSettlementPendingVoidOperations" = "Could not perform settlement - there are pending void operations";  //Do not translate
"MsgFirstDataCreditCardBatchOpearationTimeout" = "Operation was not completed. Operation has timed out";  //Do not translate
"MsgFirstDataCreditCardReportCompleted" = "Report was generated successfully";  //Do not translate
"MsgFirstDataCreditCardRefundsDisabled" = "FirstData partial refunds are disabled";  //Do not translate
"MsgFirstDataCreditCardBatchFormReport" = "Press Report to form payments report";  // b1525;
"MsgFirstDataCreditCardBatchSettlePayments" = "Press Settle Payments to form a report and settle all payments";  // b1525;
"MsgFirstDataCreditCardBatchIndicationDownloadingHostList" = "Downloading host list";  //Do not translate
"MsgFirstDataCreditCardBatchIndicationInitializingPinPad" = "Initializing PinPad";  //Do not translate
"MsgFirstDataCreditCardBatchIndicationSettlingPaymentsForHost" = "Settling payments for host ";  //Do not translate
"MsgFirstDataCreditCardBatchIndicationDownloadingReportForHost" = "Downloading report for host ";  //Do not translate
"MsgFirstDataCreditCardInitializationSuccess" = "Pin Pad initialization completed";  //Do not translate
"MsgFirstDataCreditCardInitializationFailedWithError" = "Pin Pad initialization failed with error:";  //Do not translate
"BtnFirstDataCreditCardSettlePayments" = "Settle Payments"; // b1525;
"BtnFirstDataCreditCardSettlePaymenttNotSuccessfull" = "Payments were not settled. Error";  //Do not translate
"BtnFirstDataCreditCardReportPayments" = "Report";  // b1525;
"MsgFirstDataCreditCardPartialPaymentsAreNotSupported" = "Partial payments are not supported for this tender type";  //Do not translate
...
"PaymentEFTPOS" = "EFTPOS";  //Do not translate
...
"PaymentCheck" = "Check";
"PaymentLevelUp" = "LevelUp";  //Do not translate
"PaymentCustomerCredit" = "Cust. Credit";
"PaymentIndex" = "Index";
"PaymentDebit" = "Debit";
"PaymentBadge" = "Badge";
"PaymentMW" = "MW";  //Do not translate
"PaymentPaypal" = "PayPal";  //Do not translate
"PaymentEbtFoodstamp" = "EBT Foodstamp";  //Do not translate
"PaymentEbtCash" = "EBT Cash";  //Do not translate
"PaymentEbtVoucher" = "EBT Voucher";  //Do not translate
"PaymentPreAuthFinalize" = "Finalize Payment";
"PaymentPreAuthCancel" = "Cancel PreAuth";
"PaymentZapper" = "Zapper";  //Do not translate
"PaymentWoraPay" = "WoraPay"; //Do not translate
"PaymentStanfordCard" = "Stanford Card";
"PaymentStoreCredit" = "Store Credit";
"PaymentVouchers" = "Vouchers";

"CardTypeVisa" = "VISA";  //Do not translate
"CardTypeAmericanExpress" = "AMEX";  //Do not translate
"CardTypeDiscover" = "DISCOVER";  //Do not translate
"CardTypeMastercard" = "MASTERCARD";  //Do not translate
"CardTypeMaestro" = "MAESTRO";  //Do not translate
"CardTypeOther" = "OTHER";
"CardTypeTrade" = "TRADE";
"CardTypeHouseAccount" = "HOUSE ACCOUNT";
"CardTypeGiftCard" = "GIFT CARD";
"CardTypeDebit" = "DEBIT";
"CardTypeEFTPOS" = "EFTPOS";  //Do not translate
"CardTypeDiners" = "DINERS";  //Do not translate
"CardTypeJCB" = "JCB";  //Do not translate

"CardTypeVisaShort" = "Visa";  //Do not translate
"CardTypeAmericanExpressShort" = "Amex";  //Do not translate
"CardTypeDiscoverShort" = "Disc";  //Do not translate
"CardTypeMastercardShort" = "MC";  //Do not translate
"CardTypeMaestroShort" = "Maestro";  //Do not translate
"CardTypeEFTPOSShort" = "EFTPOS";  //Do not translate
"CardTypeDinersShort" = "Diners";  //Do not translate
"CardTypeJCBShort" = "JCB";  //Do not translate

/*Check Processing*/
"MsgPaymentEnterCheckOrCustomOptionNumber" = "Enter %@ Number";
"MsgPaymentScanningMICR" = "Waiting for you to scan the check.";  //Do not translate
"MsgPaymentScanMICRUserPrompt" = "Please insert your check and press OK.";  //Do not translate
"MsgPaymentScanMICRError" = "Failed to read check data.";  //Do not translate
"MsgPaymentMICRParsingError" = "Failed to parse check data.";  //Do not translate
"MsgPaymentCheckNotVerified" = "Check cannot be verified.";  //Do not translate
"MsgPaymentCheckVerified" = "VERIFIED";  //Do not translate
"MsgPaymentCheckProcessorUnAvailable" = "No available Check Processors to verify check. Please check your settings...";  //Do not translate

"MsgPaymentCheckAccountVerified" = "Account Verified - The checking account was found to be an open and valid account.";  //Do not translate
"MsgPaymentCheckAMEXVerified" = "AMEX Cheque – The account was found to be an open and valid American Express account.";  //Do not translate
"MsgPaymentCheckNPPVerified" = "Non-Participant Provider – This item was reported with acceptable, positive data found in recent or current transactions.";  //Do not translate
"MsgPaymentCheckNPANotVerified" = "Non-Reporting Account - The bank is not able to report on this account at this time. This could be the result of a bank acquisition. Please contact the bank for additional information.";  //Do not translate
"MsgPaymentCheckSAVVerified" = "Savings Account Verified - The savings account was found to be an open and valid account.";  //Do not translate
"MsgPaymentCheckNODataNoVerified" = "No positive or negative information has been reported on the account. This could be a small or regional bank that does not report.";  //Do not translate
"MsgPaymentCheckNODataUSAGovernmentNoVerified" = "No positive or negative information has been reported on the account. This routing number is only valid for US Government financial institutions. Please verify this check with its issuing authority.";  //Do not translate
"MsgPaymentCheckVerificationNotPassed" = "Verification Failed";  //Do not translate
"MsgPaymentCheckValidationPrinting" = "Printing ... Please wait";  //Do not translate
"MsgPaymentVerificationMessage" = "Verification ... Please wait";  //Do not translate
"MsgPaymentCheckEndorseDepositOnly" = "For Deposit Only";  //Do not translate
"MsgPaymentCheckEndorseBankAccount" = "Bank Account";  //Do not translate
"MsgPaymentCheckEndorseCheckNumber" = "Check Number";  //Do not translate
...
"BtnOrderChargeBack" = "Charge Back";
...
/* REQUIRE CLOCK IN TO ACCESS FEATURE*/
...
"MsgBarTabCardReaderConnected" = "Ready to Swipe";  //Do not translate

/*Twitter View*/
"MsgTwitterTweetSent" = "Tweet Sent!";  //Do not translate
"MsgTwitterStr" = "Twitter";  //Do not translate
"MsgTwitterTouchComposeToTweet" = "Touch Compose to Tweet!";  //Do not translate
"BtnTwitterPickImage" = "Pick Image";  //Do not translate
"BtnTwitterClearImage" = "Clear Image";  //Do not translate
"BtnTwitterCompose" = "Twitter";  //Do not translate
"BtnTwitterDone" = "Done";  //Do not translate
...
/* General Payment */
/*RCMercuryPayService*/
"MsgMercuryPayServiceMercuryPayHC" = "MercuryPay HC";  //Do not translate
"MsgMercuryPayServiceErrorOccurredInternet" = "Error occurred. Please check your internet connection!";  //Do not translate
"MsgMercuryPayServicePreAuth" = "PreAuth";  //Do not translate
"MsgMercuryPayServiceNODECOUNTZERO" = "NODE COUNT ZERO!";  //Do not translate
"MsgMercuryPayServiceMercuryPayError" = "MercuryPay Error";  //Do not translate
"MsgMercuryPayServiceTranCodeNotSupported" = "TranCode: %@ NOT SUPPORTED!\nTextResponse: %@";  //Do not translate
"MsgMercuryPayServiceContextEmpty" = "Context empty! Try another payment method!";  //Do not translate
"MsgMercuryPayServiceCardUpdatedSuccessfully" = "Card updated successfully.";  //Do not translate
"MsgMercuryPayServiceTransactionFailed" = "Transaction Failed";  //Do not translate
"MsgMercuryPayServiceCreditXMLNodeCountZero" = "Credit XML node count zero!";  //Do not translate
"MsgMercuryPayServiceRStreamXMLNodeCountZero" = "RStream XML node count zero!";  //Do not translate
"MsgMercuryPayServiceMercuryPayIssue" = "MercuryPay Issue";  //Do not translate
"MsgMercuryPayServiceZEROAmountNotAllowed" = "ZERO amount is not allowed!";  //Do not translate
"MsgMercuryPayServiceMercuryPaySaleError" = "MercuryPay Sale Error";  //Do not translate
"MsgMercuryPayServiceAmountIsZERO" = "Amount is ZERO!";  //Do not translate
"MsgMercuryPayServiceSaleTransactionFailed" = "Sale transaction failed!";  //Do not translate
"MsgMercuryPayServiceMercuryPayReturn" = "MercuryPay Return";  //Do not translate
"MsgMercuryPayServiceMissingInformationToProcessReturn" = "Missing information to process Return transaction for invoice: %@!";  //Do not translate
"MsgMercuryPayServiceMercuryPayPreAuthError" = "MercuryPay PreAuth Error";  //Do not translate
"MsgMercuryPayServicePreAuthTransactionFailed" = "PreAuth transaction failed!";  //Do not translate
"MsgMercuryPayServiceMercuryPreAuthCapture" = "Mercury PreAuthCapture";  //Do not translate
"MsgMercuryPayServiceAmountGratuityTokenInvoiceEtc" = "\n\namount: %@, gratuity: %@, token: %@, invoice: %@, memo: %@, authCode: %@, acqRefData: %@, processData: %@\n\n";  //Do not translate
"MsgMercuryPayServiceCaptureTransactionFailed" = "Failed to capture transaction!";  //Do not translate
"MsgMercuryPayServiceMercuryPayDebit" = "MercuryPay Debit";  //Do not translate
"MsgMercuryPayServiceEnterAmount" = "Enter Amount";  //Do not translate
"MsgMercuryPayServiceHittingSecondaryServer" = "Hitting secondary server.";  //Do not translate

/*RSUSAePayService*/
"MsgUSAePayServiceCardNumberOrMagStripeDataEmpty" = "Card Number or MagStripe data empty!";  //Do not translate
"MsgUSAePayServiceUSAePayError" = "USA ePay Error";  //Do not translate
"MsgUSAePayServiceTransactionCaptureFailed" = "Failed to capture transaction.";  //Do not translate
"MsgUSAePayServiceUSAEPAYREFUNDERROR" = "USA EPAY REFUND ERROR";  //Do not translate
"MsgUSAePayServiceRefundAmountShouldNotBeZERO" = "Refund amount should not be ZERO! Write down this refNum: %d.";  //Do not translate
"MsgUSAePayServiceUSAePayVoidError" = "USA ePay Void Error";  //Do not translate
...
/*Payment Processors*/
"MsgPaymentProcessorsIndexPaymentFailed" = "Index Payment Failed";  //Do not translate
"MsgPaymentProcessorsIndexPaymentInfo" = "Index Payment Info";  //Do not translate
"MsgPaymentProcessorsPay" = "Pay";  //Do not translate
"MsgPaymentProcessorsTotalDiscount" = "Total Discount";  //Do not translate
"MsgPaymentProcessorsPayTotal" = "Pay Total";  //Do not translate
"MsgPaymentProcessorsAuthorizing" = "Authorizing";  //Do not translate
"MsgPaymentProcessorsScanQRcode" = "Scan QR Code";  //Do not translate
"MsgPaymentProcessorsPleaseScanQRcode" = "Please scan the QR code.";  //Do not translate
"MsgPaymentProcessorsCouldNotConnectToBS" = "Could not connect to barcode scanner.";  //Do not translate
"MsgPaymentProcessorsProcessingPleaseWait" = "Processing, please wait...";
"MsgPaymentProcessorsOrderIsAuthorized" = "Order is authorized and will be added to the group owner's tab.";  //Do not translate
"MsgPaymentProcessorsTransactionFailed" = "Transaction failed! Try again or pay using a different method.";  //Do not translate
"MsgPaymentProcessorsOrderIsUnauthorized" = "Order is unauthorized! Try again or pay using a different method.";  //Do not translate
"MsgPaymentProcessorsPartialPaymentNotSupported" = "Partial payment is not supported for this payment type.";  //Do not translate

/*CreditCard Processors*/
"MsgCreditCardProcessorsTryingToLogin" = "Trying to Login...";  //Do not translate
"MsgCreditCardProcessorsInitializingAdyenDevice" = "Initializing Adyen Device...";  //Do not translate
"MsgCreditCardProcessorsAdyenDevice" = "Adyen Device";  //Do not translate
"MsgCreditCardProcessorsADisNotConfigured" = "Adyen device is not configured.\nConfigure?";  //Do not translate
"MsgCreditCardProcessorsRetryingDeviceConnection" = "Retrying Device Connection";  //Do not translate
"MsgCreditCardProcessorsCouldNotConnectToAD" = "Could not connect to the Adyen device.";  //Do not translate
"MsgCreditCardProcessorsPrintingReceipt" = "Printing Receipt";  //Do not translate
"MsgCreditCardProcessorsFailedToLogin" = "Failed to Login";  //Do not translate
"MsgCreditCardProcessorsTransactionFailed" = "Transaction Failed";  //Do not translate
"MsgCreditCardProcessorsTransactionApproved" = "Transaction Approved";  //Do not translate
"MsgCreditCardProcessorsIdentifyingPD" = "Identifying Payment Device";  //Do not translate
"MsgCreditCardProcessorsRegisteringPD" = "Registering Payment Device";  //Do not translate
"MsgCreditCardProcessorsLoadingConfiguration" = "Loading Configuration";  //Do not translate
"MsgCreditCardProcessorsStoreConfiguration" = "Store Configuration";  //Do not translate
"MsgCreditCardProcessorsCheckingConfiguration" = "Checking Configuration";  //Do not translate
"MsgCreditCardProcessorsADSuccessfullyConfigured" = "Adyen Device Successfully Configured";  //Do not translate
"MsgCreditCardProcessorsFailedToConfigureDevice" = "Failed to Configure Device";  //Do not translate
"MsgCreditCardProcessorsCancelling" = "Cancelling";  //Do not translate
"MsgCreditCardProcessorsConfiguring" = "Configuring";  //Do not translate
"MsgCreditCardProcessorsQuestPayment" = "Quest Payment";  //Do not translate
"MsgCreditCardProcessorsManualPaymentPinPad" = "Please perform the manual payment on the PinPad";  //Do not translate
"MsgCreditCardProcessorsAdyenManualCreditIsNotSupported" = "Manually inputting credit card data is not supported by Adyen payments.";  //Do not translate
"MsgCreditCardProcessorsManualCreditIsNotSupported" = "Manually inputting credit card data is not supported.";  //Do not translate
"MsgCreditCardProcessorsUserCancelledTransaction" = "User Cancelled Transaction";  //Do not translate
...
"MsgGenPaymentMercuryPayDoesNotSuppThisSwipe" = "MercuryPay does not support this type of card swipe.";  //Do not translate
"MsgGenPaymentMercuryPayUrlIncorrect" = "MercuryPay service url is incorrect.\nPlease contact customer support.";  //Do not translate
"MsgGenPaymentIntuitDoesNotSuppThisSwipe" = "Intuit does not support this type of card swipe.";  //Do not translate
"MsgGenPaymentWorldPayPayUrlIncorrect" = "WorldPay service url is incorrect.\nPlease contact customer support.";  //Do not translate
...
"MsgGenPaymentMercuryPay" = "MercuryPay";  //Do not translate
...
"MsgGenPaymentEBTCashSale" = "EBT Cash Sale";  //Do not translate
"MsgGenPaymentEBTFoodStampSale" = "EBT Food Stamp Sale";  //Do not translate
"MsgGenPaymentEBTFoodStampVoucherSale" = "EBT Food Stamp Voucher Sale";  //Do not translate
"MsgGenPaymentEBTTransactionTypes" = "EBT Transaction Types";  //Do not translate
...
"MsgVoidRefundPaymentsOfAmountWillBeRefunded" = "Payments of %@ will be refunded.";
...
"MsgTipProcessingSearchFieldPlaceHolder" = "Order ID, Customer, Employee";
...
"MsgServicesCheckScanImpToConfig" = "Impossible to Configure";  //Do not translate
"MsgServicesCheckScanWritePortTimout" = "Write Port Time Out";  //Do not translate
"MsgServicesCheckScanDataError" = "Check Data Error";  //Do not translate
"MsgServicesCheckScanFailedReadPort" = "Failed to Read Port";  //Do not translate
"MsgServicesCheckScannigMessage" = "Scanning ... Please wait.";  //Do not translate
...
"MsgScrSettingsCheckSyncStatus" = "Check Sync Status";
...
"MsgScrSettingsOptimizeLayoutInfo" = "Please logout out of the POS and back in to see the new layout.";
...
"MsgScrSettingsTipOVER25" = "Tip exceeds OVER 25%!"; // NOT USED
...
"MsgScrSettingsOfflineCreditCardProcessingStart" = "Start Offline Credit Processing";
"MsgScrSettingsOfflineCreditCardProcessingStop" = "Stop Offline Credit Processing";
...
"MsgScrSettingsNetworkSyncFailureDetails" = "Failed Payment Details";
...
"MsgScreenVersionEstablishmentStation" = "Version: %@\nEstablishment ID: %d\nStation Name: %@\n Device ID: %@\n URL: %@";
...
/*Libraries*/
/*AdyenService*/
"MsgLibAdyenVoidTransFailed" = "Failed to Void Transaction";  //Do not translate
"MsgLibAdyenVoidTrans" = "Void Transaction";  //Do not translate
"MsgLibAdyenFailed" = "Failed";  //Do not translate
"MsgLibAdyenApproved" = "Approved";  //Do not translate
"MsgLibAdyenDeclined" = "Declined";  //Do not translate
"MsgLibAdyenCancelled" = "Cancelled";  //Do not translate
"MsgLibAdyenSignaturePrompt" = "Signature Prompt";  //Do not translate

/*IndexPayments*/
"MsgLibIndexPayIndexRefundFailed" = "Index Refund Failed";  //Do not translate
"MsgLibIndexWaitingForCustomerResponse" = "Waiting for customer's response...";  //Do not translate
"MsgLibIndexWaitingForCustomer" = "Waiting for customer to confirm...";  //Do not translate
"MsgLibIndexAskCustomerEnterEmail" = "Please ask customer to enter email address for rewards + receipt.";  //Do not translate
"MsgLibIndexAskCustomerEnterEmailOrScan" = "Ask customer to enter Email\nor\nScan Mobile QR.";  //Do not translate
"MsgLibIndexFurtherActions" = "Further Actions";  //Do not translate
"MsgLibIndexWaitingForPin" = "Waiting for PIN from Display Unit...";  //Do not translate
"MsgLibIndexChallengeQuestion" = "Challenge Question";  //Do not translate
"MsgLibIndexFailedToLogin" = "Failed to Log In to Index.";  //Do not translate
"MsgLibIndexFailedToPreview" = "Failed to Preview";  //Do not translate
"MsgLibIndexFailedToAttachLoyalty" = "Failed to Attach Loyalty";  //Do not translate
"MsgLibIndexFailedToCreateLoyalty" = "Failed to Create Loyalty";  //Do not translate
"MsgLibIndexEnterEmail" = "Enter Email Address";  //Do not translate
"MsgLibIndexEnterValidEmail" = "Enter Valid Email Address";  //Do not translate
"MsgLibIndexCancelTransactionConfirm" = "Current payment will be cancelled. Are you sure?";  //Do not translate
"MsgLibIndexSkipRewardsConfirm" = "Email address will not be attached. Are you sure?";  //Do not translate
"MsgLibIndexIndexNotAllowed" = "Index is not allowed for this payment.";  //Do not translate
"MsgLibIndexGratuityAmountExceed" = "Gratuity amount cannot exceed the receipt amount.";  //Do not translate
"MsgLibIndexSimulateOffline" = "Simulate Offline";  //Do not translate
"MsgLibIndexPaymentIsNotAllowedInOffline" = "This payment not supported offline. Please try another payment method!";  //Do not translate
"MsgLibIndexWrongQrCode" = "Wrong QR code.";
"MsgIndexError" = "Index Error";

"BtnSkipRewards" = "Skip Rewards";  //Do not translate
"ActionCreateLoyalty" = "Create Loyalty";  //Do not translate
"ActionAttachLoyalty" = "Attach Existing Loyalty";  //Do not translate
"ActionContinue" = "Continue";  //Do not translate

/*InfineaTab*/
"MsgLibInfineaTabBatteryCheck" = "Battery Check";  //Do not translate
"MsgLibInfineaTabCRITICALWARNING" = "CRITICAL WARNING";  //Do not translate
"MsgLibInfineaTabBatteryAt" = "Battery at %d%%\nPlease charge the card swipe immediately or lose complete functionality of the swipe!";  //Do not translate
"MsgLibInfineaTabDisconnected" = "Disconnected";  //Do not translate
...
/*RBA Service*/
"MsgLibRBATryAgain" = "348 - Try Again";  //Do not translate
"MsgLibRBANoPinpad" = "PinPad not connected!\nPlease log out and log in again.";  //Do not translate
"MsgLibRBAProcessPINdata" = "Processing PinPad Data...";  //Do not translate
...
/*LevelUp*/
"MsgLibLevelUpLevelUpError" = "LevelUp Error";  //Do not translate
"MsgLibLevelUpTipOver100" = "Tip percentage exceeds 100%! Please rescan QR code!";  //Do not translate
"MsgLibLevelUpTipWarn" = "LevelUp Tip Warning";  //Do not translate
"MsgLibLevelUpEnterQRCode" = "Enter QR Code";  //Do not translate
"MsgLibLevelUpScanQRCode" = "Please ask the customer to scan their QR Code now.";  //Do not translate
"MsgLibLevelUpNoQRCodeScan" = "No QR Code scanned.";  //Do not translate
"MsgLibLevelUpTransFailed" = "Transaction failed! Try again or pay using a different method.";  //Do not translate
"MsgLibLevelUpInvalidAuth" = "Invalid Authentication";  //Do not translate
...
"MsgInventoryResultSelectItemsToRecieve" = "Select items to receive";
...
"MsgPunchhUserCreate" = "Punchh user creating...";
...
"MsgPunchhBankedRewards" = "Banked rewards";
"MsgPunchhUnredeemCards" = "Unredeemed cards";
"MsgPunchhUserManage" = "Manage Punchh User";
...
/*Sandisk*/
"MsgSandiskEnterID" = "Enter your ID";  //Do not translate
"MsgSandiskWrongID" = "Invalid ID";  //Do not translate
"MsgSandiskAuthenticating" = "Authenticating...";  //Do not translate
"MsgSandiskAuthenticationFailed" = "Authentication failed. Please try again.";  //Do not translate
"MsgSandiskAnyProductOverflow" = "Employee is only allowed to purchase a total of %d item(s) in the past %d days. They may purchase %d more item(s) as they have already purchased %d these past %d days.";  //Do not translate
"MsgSandiskEachProductOverflow" = "Employee is only allowed to purchase %@ product %d times in the past %d days. They may purchase only %d more of %@ item.";  //Do not translate
"MsgSandiskScanID" = "Scan your ID";  //Do not translate
"MsgSandiskValidating" = "Validating...";  //Do not translate
"MsgSandiskValidationFailed" = "Validation failed. Please retry.";  //Do not translate

/*Welcome*/
"MsgWelcomeDemoConfig" = "Application will now load demo configuration. Your user PIN will be sent to %@.";

/*BarTab/Table Pre-Authorization*/
...
/*Boca printer settings*/
"MsgBocaPrinterSettings" = "Boca Ticket Printer Settings";  //Do not translate
"BtnGetStatus" = "Get Status";  //Do not translate
"BtnPrintTestTicket" = "Print Test Ticket";  //Do not translate
"BtnSelectImage" = "Select Image";  //Do not translate

/*Ticket strings*/

"MsgTicketStringPresenting" = "Presenting";  //Do not translate
"MsgTicketStringScreen" = "Screen";  //Do not translate
"MsgTicketStringRating" = "Rating";  //Do not translate
"MsgTicketStringRetainStub" = "PLEASE RETAIN THIS STUB";  //Do not translate
"MsgTicketStringStartTime" = "Time";  //Do not translate

/* caller Id */
"MsgCidCallerIdManager" = "Incoming Calls";  //Do not translate
"MsgCidIncomingCall" = "Incoming Call";  //Do not translate
"MsgCidLoginToProcess" = "Login to Process";  //Do not translate
"MsgCidHoldOrder" = "Hold Order";  //Do not translate
"MsgCidPastCalls" = "Past Calls";  //Do not translate
"MsgCidSearchInstructions" = "Search by Date, Caller Name, Ref Number or Email";  //Do not translate
"MsgCidDate" = "Date";  //Do not translate
"MsgCidTime" = "Time";  //Do not translate
"MsgCidName" = "Name";  //Do not translate
"MsgCidPhoneNumber" = "Phone Number";  //Do not translate
"MsgCidCity" = "City";  //Do not translate
"MsgCidState" = "State";  //Do not translate
"MsgCidZip" = "Zip";  //Do not translate
...
"MsgCustomDeliveryUberRush" = "UberRUSH"; //Do not translate
...
/* Postmates Delivery Management */
"MsgCustomDeliveryPostmates" = "Postmates"; //Do not translate
...
"MsgDonation" = "Donation";  //Do not translate
"MsgDonationSelectAmount" = "Select Donation Amount";  //Do not translate
"MsgDonationChange" = "Change";  //Do not translate
"MsgDonationOther" = "Other";  //Do not translate
"MsgDonationAlreadyAdded" = "Donation already added, remove it?";  //Do not translate
...
/*Social*/
"MsgSocialFSSelectVenue" = "Select Venue";  //Do not translate
"MsgSocialFSNoVenuesError" = "No Venues Returned";  //Do not translate


/*Fiscal Printer*/
"MsgFiscalOrderImpossibleToOpenOrder" = "Order could not be opened.";  //Do not translate
"MsgFiscalCreditNoteImpossibleToOpen" = "Credit note could not be opened.";  //Do not translate
"MsgFiscalProductImpossibleToAdd" = "Product could not be added.";  //Do not translate
"MsgFiscalOrderClosingFailed" = "Failed to Close Order";  //Do not translate
"MsgFiscalCreditNoteFailed" = "Credit Note Failed";  //Do not translate
"MsgFiscalOrderCancelFailed" = "Failed to Cancel Operation";  //Do not translate
"MsgFiscalOrderPrinting" = "Fiscal operation is in progress. Please wait.";  //Do not translate
"MsgFiscalOperationFailed" = "Failed to register fiscal operation.";  //Do not translate
"MsgFiscalSerialFetchFailed" = "Serial Number could not be received.";  //Do not translate
"MsgFicalServiceOption" = "Options";  //Do not translate
"MsgFiscalReportFailed" = "Fiscal Report Failed";  //Do not translate
"MsgBematechServiceOptionsTitle" = "Bematech Service Options";  //Do not translate
"BtnFiscalReadX" = "X Report";
"BtnFiscalReadZ" = "Z Report";
"MsgFiscalCOOPlaceholder" = "Enter COO Counter";  //Do not translate
"MsgFiscalCOOLabel" = "COO Counter";  //Do not translate
"MsgFiscalSerialNumberPlaceholder" = "Enter Printer Serial Number";  //Do not translate
"MsgFiscalSerialNumberLabel" = "Printer Serial Number";  //Do not translate
"MsgFiscalEnterSerailAndCOOTitle" = "Serial Number and COO";  //Do not translate
"MsgFiscalTaxProgrammingFailed" = "Tax Program Failed";  //Do not translate
"MsgFiscalTaxProgrammingUpdated" = "Taxes Updated";  //Do not translate
"BtnFiscalSetupTax" = "Setup Tax";  //Do not translate
...
//SSMC
"MsgSSMCRedeemPoints" = "Would you like to redeem Loyalty Points?\n\nYour reward balance is %d points";  //Do not translate
"MsgRewardSSMCGetAmountRedeem" = "Insufficient funds to redeem Loyalty Points\n\n Your reward balance is %d points";  //Do not translate
"PaymentSsmc" = "SSMC";  //Do not translate
"PaymentSsmcButton" = "App";  //Do not translate
"MsgSSMCPaymentEarningPoint" = "Waiting for loyalty points...";  //Do not translate
"MsgFailedToApplyLoyalty" = "SSMC transaction failed.\n\n Loyalty points were not added.";  //Do not translate
"MsgFailedToGetUserInfo" = "Could not receive customer detail info.";  //Do not translate
"MsgFailedToLoadCheckins" = "Could not receive checked in customer list.";  //Do not translate
"MsgPaymentTippingNotSupportedSsmc" = "Tipping not supported for SSMC Payments.";  //Do not translate
"MsgSSMCCheckInTime" = "Check In";
"MsgAdditionalInfo" = "Additional Info";  //Do not translate
...
"MsgDuFromImagePicker" = "From ImagePicker";
...
//Order Table Empoyee Record Picker
...
"MsgMergeOrderSplitBillsClear" = "Split bills on order: %@ will be cleared. Are you sure?";
...
"MsgWetstockAmtDispenced" = "Amt. Dispenced";
...
"MsgHouseAccountUnpaidHouseAccountOrders" = "Unpaid House Account Orders";
...
"MsgHouseAccountErrorFailedToSyncPayment" = "Failed to sync House Account payment.";
...
"MsgOnboardingEnableOneTouchMenu" = "Enable One Touch Menu";
"MsgOnboardingTurnOnDynamicMenuHeaders" = "Turn on Dynamic Menu Headers";
"MsgOnboardingStayOnLastItemAfterProductSelection" = "Stay on Last Item After Product Selection";
"MsgOnboardingOneTouchMenuTip" = "This allows you to see only your categories on the Menu instead of categories, subcategories, and products. By the clicking on a specific category you will be able to that category’s subcategories. From there you can click on a subcategory and be able to see its’ products. Must be enabled to activate Stay On Last Item After Product Selection.";
"MsgOnboardingDynamicMenuHeadersTip" = "Adds a menu bar to the POS, above categories and products. The menu bars displays the currently selected category/subcategory. These icons can be used to navigate between different categories/subcategories.";
...
//not returnable item
"MsgOnThisItemNotPossible" = "on this item is not possible";//e.g. Context: comp on this item is not possible
"MsgOnThisItemAreNotPossible" = "on this item are not possible";//e.g. Context: comp and exchange on this item are not possible
"MsgOnThisItemAreNotPossibleAND" = "and";//used for construct sentense and or ","
...
"MsgDragontailAddCustomer" = "Please add customer with valid delivery address to proceed";
